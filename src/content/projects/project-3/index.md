...
Micro adds features like [Pagefind](https://pagefind.app) for search, [Giscus](https://giscus.app) for comments, and more. For a full list of changes, see this [blog post](/posts/00-micro-changelog).
...
and [more](/posts/00-micro-changelog).
